...
public partial class @SilantroControl : IInputActionCollection2, IDisposable
{
    ...
    private IAircraftActions m_AircraftActionsCallbackInterface;
    ...
    public struct AircraftActions
    {
        ...
        {
            if (m_Wrapper.m_AircraftActionsCallbackInterface != null)
            {
                @StartEngineGlobal.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStartEngineGlobal;
                @StartEngineGlobal.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStartEngineGlobal;
                @StartEngineGlobal.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStartEngineGlobal;
                @StopEngineGlobal.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStopEngineGlobal;
                @StopEngineGlobal.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStopEngineGlobal;
                @StopEngineGlobal.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnStopEngineGlobal;
                @LeftEngineSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLeftEngineSwitch;
                @LeftEngineSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLeftEngineSwitch;
                @LeftEngineSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLeftEngineSwitch;
                @RightEngineSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRightEngineSwitch;
                @RightEngineSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRightEngineSwitch;
                @RightEngineSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRightEngineSwitch;
                @BoostSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBoostSwitch;
                @BoostSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBoostSwitch;
                @BoostSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBoostSwitch;
                @FlapDownSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapDownSwitch;
                @FlapDownSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapDownSwitch;
                @FlapDownSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapDownSwitch;
                @FlapUpSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapUpSwitch;
                @FlapUpSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapUpSwitch;
                @FlapUpSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFlapUpSwitch;
                @CameraSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCameraSwitch;
                @CameraSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCameraSwitch;
                @CameraSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCameraSwitch;
                @LightSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLightSwitch;
                @LightSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLightSwitch;
                @LightSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnLightSwitch;
                @GearActuation.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnGearActuation;
                @GearActuation.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnGearActuation;
                @GearActuation.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnGearActuation;
                @BrakeHold.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBrakeHold;
                @BrakeHold.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBrakeHold;
                @BrakeHold.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnBrakeHold;
                @ParkingBrake.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnParkingBrake;
                @ParkingBrake.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnParkingBrake;
                @ParkingBrake.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnParkingBrake;
                @SpeedBrake.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnSpeedBrake;
                @SpeedBrake.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnSpeedBrake;
                @SpeedBrake.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnSpeedBrake;
                @MouseDelta.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMouseDelta;
                @MouseDelta.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMouseDelta;
                @MouseDelta.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMouseDelta;
                @ThrottleLever.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnThrottleLever;
                @ThrottleLever.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnThrottleLever;
                @ThrottleLever.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnThrottleLever;
                @CollectiveLever.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCollectiveLever;
                @CollectiveLever.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCollectiveLever;
                @CollectiveLever.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCollectiveLever;
                @MixtureLever.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMixtureLever;
                @MixtureLever.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMixtureLever;
                @MixtureLever.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnMixtureLever;
                @PropPitchLever.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPropPitchLever;
                @PropPitchLever.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPropPitchLever;
                @PropPitchLever.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPropPitchLever;
                @CarbHeatLever.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCarbHeatLever;
                @CarbHeatLever.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCarbHeatLever;
                @CarbHeatLever.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnCarbHeatLever;
                @PitchInput.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchInput;
                @PitchInput.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchInput;
                @PitchInput.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchInput;
                @PitchTrimDown.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimDown;
                @PitchTrimDown.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimDown;
                @PitchTrimDown.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimDown;
                @PitchTrimUp.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimUp;
                @PitchTrimUp.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimUp;
                @PitchTrimUp.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnPitchTrimUp;
                @RollInput.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollInput;
                @RollInput.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollInput;
                @RollInput.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollInput;
                @RollTrimRight.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimRight;
                @RollTrimRight.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimRight;
                @RollTrimRight.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimRight;
                @RollTrimLeft.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimLeft;
                @RollTrimLeft.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimLeft;
                @RollTrimLeft.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRollTrimLeft;
                @YawInput.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawInput;
                @YawInput.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawInput;
                @YawInput.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawInput;
                @YawTrimLeft.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimLeft;
                @YawTrimLeft.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimLeft;
                @YawTrimLeft.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimLeft;
                @YawTrimRIght.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimRIght;
                @YawTrimRIght.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimRIght;
                @YawTrimRIght.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnYawTrimRIght;
                @RestoreAircraft.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRestoreAircraft;
                @RestoreAircraft.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRestoreAircraft;
                @RestoreAircraft.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnRestoreAircraft;
                @ResetScene.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnResetScene;
                @ResetScene.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnResetScene;
                @ResetScene.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnResetScene;
                @FireHold.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFireHold;
                @FireHold.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFireHold;
                @FireHold.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFireHold;
                @FirePress.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFirePress;
                @FirePress.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFirePress;
                @FirePress.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnFirePress;
                @WeaponSwitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnWeaponSwitch;
                @WeaponSwitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnWeaponSwitch;
                @WeaponSwitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnWeaponSwitch;
                @ViewHatswitch.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnViewHatswitch;
                @ViewHatswitch.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnViewHatswitch;
                @ViewHatswitch.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnViewHatswitch;
                @TargetUp.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetUp;
                @TargetUp.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetUp;
                @TargetUp.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetUp;
                @TargetDown.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetDown;
                @TargetDown.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetDown;
                @TargetDown.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetDown;
                @TargetLock.started -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetLock;
                @TargetLock.performed -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetLock;
                @TargetLock.canceled -= m_Wrapper.m_AircraftActionsCallbackInterface.OnTargetLock;
            }
            m_Wrapper.m_AircraftActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public struct HelicopterActions
    {
        ...
        public void SetCallbacks(IHelicopterActions instance)
        {
            ...
            {
                @ActuatorLever.started -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnActuatorLever;
                @ActuatorLever.performed -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnActuatorLever;
                @ActuatorLever.canceled -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnActuatorLever;
                @YawInput.started -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnYawInput;
                @YawInput.performed -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnYawInput;
                @YawInput.canceled -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnYawInput;
                @RollInput.started -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnRollInput;
                @RollInput.performed -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnRollInput;
                @RollInput.canceled -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnRollInput;
                @PitchInput.started -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnPitchInput;
                @PitchInput.performed -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnPitchInput;
                @PitchInput.canceled -= m_Wrapper.m_HelicopterActionsCallbackInterface.OnPitchInput;
            }
