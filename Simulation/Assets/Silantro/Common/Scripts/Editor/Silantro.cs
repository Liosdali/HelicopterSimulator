...
namespace Oyedoyin.Common.Editors
{
    public class CommonElements
    {
        ...
        public static void EnableNotifications()
        {
            ...
            File.WriteAllText(_location, "3.511;3.511;YES");
        ...
        {
            string _location = "Assets/Silantro/Common/Storage/Silantro_UPDATE.txt";
            File.WriteAllText(_location, "3.511;3.511;NO");
    ...
    public class BetaNotification : ScriptableObject
    {
        ...
        private void ShowNotification()
        {
            ...
            else
            {
                ...
                if (l_command == "NO")
                {
                    EditorUtility.DisplayDialog("Silantro Beta Notification",
                           "Welcome to asset version 3.511." +
                    #region Space
                           "\n" +
                           "" +
                           "\n" +
                           "" +
                    #endregion
                           "For a few weeks after initial release, the asset will be in beta to test out new features, finish the ones in development and fix reported bugs." +
                    #region Space
                           "\n" +
                           "" +
                           "\n" +
