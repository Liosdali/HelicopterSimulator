...
namespace Oyedoyin.RotaryWing
{
    ...
    public class Fuselage
    {
        ...
        public void Compute()
        {
            ...
            moment = Transformation.MomentToUnity(m_moment);
            m_core.controller.m_rigidbody.AddForce(force);
            m_core.controller.m_rigidbody.AddTorque(moment);
        }
        public Vector3 force, moment;
    }
